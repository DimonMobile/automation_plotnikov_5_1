/**
 * ECMAScript - стандарт или же спецификация, JavaScript - реализация спецификации ECMAScript.
 * На данный момент актуальная версия 10th Edition - ECMAScript 2019
 * Node.js - программная платформа, предназначенная в первую очередь для простого построения масштабируемых сетевых серверов
 */
